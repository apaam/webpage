...
![node_example](/img/node-example.png "Example of node layout for importing and rendering vtk polydate in blender.")

- Switch back to the ``3D Viewport`` editor, and you should get a scene as following.

![render_example](/img/render-example.png "Example of layort view.")
