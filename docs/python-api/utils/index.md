...
| [STLModel](stl-model.md) | 3D triangle mesh from STL/OFF |
| [Voronoi](voronoi.md) | Voronoi tessellation (Tessellation / Diagram) |
| [Cork](cork.md) | Boolean mesh operations (CorkWrapper) |
| [OpenMP](open-mp.md) | Thread control bindings |
| [Vec2d/Vec3d/Vec3i/Vec3u/Vec4d/Vec6d](vector-matrix.md) | Fixed-size vectors |
| [Mat2d/Mat3d](vector-matrix.md) | Fixed-size matrices |
| [FlatHashMap](flat-hash-map.md) | Flat hash map |
| [Shape](shape/index.md) | Geometric shapes (Sphere, Cuboid, Ellipsoid, Cylinder, ...) |
| [SurfaceMesh](surface-mesh.md) | Surface mesh struct |
| [DataIO](data-io.md) | Tabular data I/O |
| [SaveOptions / LoadOptions](save-load-options.md) | File save/load options |
| [math](math.md) | Math constants, vector ops, quaternion |
| [sampling](sampling.md) | Distribution, spatial, orientation, spherical sampling |
| [vtk](vtk.md) | VTK file I/O |
| [wrappers](wrappers.md) | Cork, CGAL, Eigen, igl, TetGen wrappers |
