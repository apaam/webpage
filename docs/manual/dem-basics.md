---
title: "Overview of DEM"
sidebar_label: "DEM basics"
---

Hub: [Theory overview](dem-wiki.md).
...
the body surface (see further discussions in **Particle representation** below). A review on the particle
...
consider the DEM system to consist of rigid bodies connected by
springs, while the latter ones consider the particles themselves to be
springs.

In the category of the SDOF-based approaches, Cundall & Strack (1979) [@Cundall_Strack_1979]
...
DEM-based numerical simulations require cyclic calculations, showing the
workflow and calculations that are involved in one typical cycle of a
DEM simulation.

![dem_workflow](/img/dem-workflow.png "The workflow and calculations that are involved in one typical cycle of a DEM simulation.")
...
to implement because the contact detection and resolution
...
(a) | (b) | (c)
----|-----|----
![overlapping_filling](/img/overlapping-filling.png "Domain overlapping filling")|![boundary_fiiling](/img/boundary-filling.png "Boundary filling")|![non_overlapping_filling](/img/non-overlapping-filling.png "Domain non-overlapping filling")
...
![rheological_contact_model](/img/rheological-contact-model.png "Schematic diagram of linear elastic model (adopted from [@Chung_2006]).")
...
![bpm_rheological_model](/img/bpm-rheological-model.png "Sketch of bonded particles and rheological components of the bond behavior.")
