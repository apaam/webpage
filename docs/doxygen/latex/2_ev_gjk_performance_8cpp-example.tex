...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}dem\_profiler.hpp"{}}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{auto}\ *ds\_q\_pos\ =\ \textcolor{keyword}{new}\ Vec3d[num\_samples];}
\DoxyCodeLine{\textcolor{keyword}{auto}\ *ds\_q\_quat\ =\ \textcolor{keyword}{new}\ Vec4d[num\_samples];}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keyword}{auto}\ *ds\_len\_n\ =\ \textcolor{keyword}{new}\ \textcolor{keywordtype}{double}[num\_samples];}
\DoxyCodeLine{\textcolor{keyword}{auto}\ *ds\_dir\_n\ =\ \textcolor{keyword}{new}\ Vec3d[num\_samples];}
\DoxyCodeLine{\textcolor{keyword}{auto}\ *ds\_pos\ =\ \textcolor{keyword}{new}\ Vec3d[num\_samples];}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ Vec3d\ rot\_axis\_sph\{1.0,\ rot\_axis\_theta,\ rot\_axis\_phi\};}
...
\DoxyCodeLine{\ \ \ \ Vec3d\ rot\_axis\ =\ Math::SphericalToCartesian(rot\_axis\_sph);}
...
\DoxyCodeLine{\ \ \ \ Vec3d\ dir\_sph\{1.0,\ dir\_theta,\ dir\_phi\};}
\DoxyCodeLine{\ \ \ \ ds\_dir\_n[i]\ =\ Math::SphericalToCartesian(dir\_sph);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ get\ the\ support\ points}}
\DoxyCodeLine{\ \ \ \ Vec3d\ sup\_pos\_1,\ sup\_pos\_2;}
\DoxyCodeLine{\ \ \ \ Vec3d\ dir\_n\_inv\ =\ -\/1.0\ *\ ds\_dir\_n[i];}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ Vec4d\ quat\_conj\ =\ Math::Quaternion::Conjugate(ds\_q\_quat[i]);}
\DoxyCodeLine{\ \ \ \ Vec3d\ dir\_n\_ref\ =\ Math::Rotate(ds\_dir\_n[i],\ quat\_conj);}
\DoxyCodeLine{\ \ \ \ Vec3d\ sup\_pos\_2\_ref\ =\ ellipsoid.\mbox{\hyperlink{classnetdem_1_1_ellipsoid_aff41be1941a2b21dcdab49bfaae55ad5}{SupportPoint}}(dir\_n\_ref);}
\DoxyCodeLine{\ \ \ \ Vec3d\ sup\_pos\_2\_rot\ =\ Math::Rotate(sup\_pos\_2\_ref,\ ds\_q\_quat[i]);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ os.precision(15);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ cnt\_solver.use\_erosion\ =\ use\_erosion;}
\DoxyCodeLine{\ \ cnt\_solver.erosion\_ratio\_initial\ =\ erosion\_ratio\_initial;}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ num\_samples;\ i++)\ \{}
\DoxyCodeLine{\ \ \ \ p2.SetPosition(ds\_q\_pos[i][0],\ ds\_q\_pos[i][1],\ ds\_q\_pos[i][2]);}
\DoxyCodeLine{\ \ \ \ p2.SetQuaternion(ds\_q\_quat[i][0],\ ds\_q\_quat[i][1],\ ds\_q\_quat[i][2],}
...
\DoxyCodeLine{\ \ dem\_profiler.\mbox{\hyperlink{classnetdem_1_1_d_e_m_profiler_aec4a998774b78edc07c06b148f0b3cf7}{StartTimer}}(TimerType::custom);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ cnt\_solver.use\_erosion\ =\ use\_erosion;}
\DoxyCodeLine{\ \ cnt\_solver.erosion\_ratio\_initial\ =\ erosion\_ratio\_initial;}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ num\_samples;\ i++)\ \{}
...
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\ \ dem\_profiler.\mbox{\hyperlink{classnetdem_1_1_d_e_m_profiler_aac02a7272beacf6e1b5a52fb9cb01d4a}{EndTimer}}(TimerType::custom);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (use\_erosion)\ \{}
\DoxyCodeLine{\ \ \ \ printf(\textcolor{stringliteral}{"{}erosion:\ \%f\ s\ \(\backslash\)n"{}},}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ dem\_profiler.\mbox{\hyperlink{classnetdem_1_1_d_e_m_profiler_a1807f89997ec1340772b0dc4cd99db6c}{timer\_list}}[TimerType::custom]\ /\ 1000000.0);}
\DoxyCodeLine{\ \ \}\ \textcolor{keywordflow}{else}\ \{}
