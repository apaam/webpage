\hypertarget{1_membrane_case_8cpp-example}{}\doxysection{1\+\_\+membrane\+\_\+case.\+cpp}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}membrane\_wall.hpp"{}}}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ cnt\_model\_0\ =\ \mbox{\hyperlink{classnetdem_1_1_linear_spring}{LinearSpring}}(2.0e5,\ 1.0e5,\ 0.7,\ 0.3);}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ cnt\_model\_1\ =\ \mbox{\hyperlink{classnetdem_1_1_linear_spring}{LinearSpring}}(2.0e5,\ 1.0e5,\ 0.7,\ 0.5);}
...
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(0,\ 0,\ cnt\_model\_0\_prt);}
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(0,\ 1,\ cnt\_model\_1\_prt);}
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(1,\ 1,\ cnt\_model\_1\_prt);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{if}\ (p\_ptr-\/>pos[2]\ >\ 0.05\ -\/\ 0.5\ *\ p\_ptr-\/>shape-\/>size)\ \{}
