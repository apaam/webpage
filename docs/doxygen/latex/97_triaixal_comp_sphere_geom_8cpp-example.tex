\doxysection{97\+\_\+triaixal\+\_\+comp\+\_\+sphere\+\_\+geom.\+cpp}
\hypertarget{97_triaixal_comp_sphere_geom_8cpp-example}{}\label{97_triaixal_comp_sphere_geom_8cpp-example}This is an example of how to use the netdem library.
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{classnetdem_1_1_hertz_mindlin}{HertzMindlin}}\ cnt\_model\ =}
\DoxyCodeLine{\ \ \ \ \ \ \mbox{\hyperlink{classnetdem_1_1_hertz_mindlin}{HertzMindlin}}(1.35e8\ *\ kn\_coef,\ 1.0e5\ *\ kn\_coef,\ friction,\ 0.0);}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ cnt\_ptr\ =\ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.\mbox{\hyperlink{classnetdem_1_1_scene_a16e8cd7195ba20a9d0bee14498b69c4f}{InsertContactModel}}(\&cnt\_model);}
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{namespacenetdem_a19bd090a5819e5163bd8d6aba69718bc}{VecXT<Particle>}}\ particle\_list\_bot\ =\ PackGenerator::GetGridPack(}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&p\ :\ particle\_list\_bot)\ \{}
\DoxyCodeLine{\ \ \ \ p.SetDensity(265000);}
\DoxyCodeLine{\ \ \ \ p.SetVelocity(0,\ 0,\ 0);}
\DoxyCodeLine{\ \ \ \ p.damp\_viscous\ =\ 3.0;}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \mbox{\hyperlink{namespacenetdem_a19bd090a5819e5163bd8d6aba69718bc}{VecXT<Particle>}}\ particle\_list\_top\ =\ PackGenerator::GetGridPack(}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&p\ :\ particle\_list\_top)\ \{}
\DoxyCodeLine{\ \ \ \ p.SetDensity(265000);}
\DoxyCodeLine{\ \ \ \ p.SetVelocity(0,\ 0,\ 0);}
\DoxyCodeLine{\ \ \ \ p.damp\_viscous\ =\ 3.0;}
\DoxyCodeLine{\ \ \}}
...
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.\mbox{\hyperlink{classnetdem_1_1_scene_a9e8ccb020b0ba1b5ab8626448ece42ae}{InsertParticle}}(particle\_list\_bot);}
...
\DoxyCodeLine{\ \ \ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.\mbox{\hyperlink{classnetdem_1_1_scene_a9e8ccb020b0ba1b5ab8626448ece42ae}{InsertParticle}}(particle\_list\_top);}
\DoxyCodeLine{\ \ \ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_a358efcc8d6d906b11ef8fce7a2624943}{Run}}(0.1);}
\DoxyCodeLine{\ \ \}}
...
\DoxyCodeLine{\ \ cnt\_ptr-\/>SetProperty(\textcolor{stringliteral}{"{}mu"{}},\ 0.3);}
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_a358efcc8d6d906b11ef8fce7a2624943}{Run}}(0.5);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ servo\_top.\mbox{\hyperlink{classnetdem_1_1_wall_servo_control_a32b386998006c5274bdef26cf8acab8f}{target\_pressure}}\ =\ pressure;}
...
\DoxyCodeLine{\ \ servo\_lateral.\mbox{\hyperlink{classnetdem_1_1_wall_servo_control_a7bbef42017ca9e870d0ce7d1b9332783}{study\_rate}}\ =\ 0.5;}
