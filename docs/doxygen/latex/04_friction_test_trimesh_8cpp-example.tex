\hypertarget{04_friction_test_trimesh_8cpp-example}{}\doxysection{04\+\_\+friction\+\_\+test\+\_\+trimesh.\+cpp}
...
\DoxyCodeLine{\ \ obj\_p2.SetPosition(-\/0.35\ -\/\ 0.001,\ 0,\ 0.95);}
\DoxyCodeLine{\ \ obj\_p2.SetVelocity(0.001,\ 0,\ 0);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ obj\_p2.UpdateMotion(1);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ cnt-\/>\mbox{\hyperlink{classnetdem_1_1_contact_p_p_ae659aec9e4dfa5ae1de393048a4406da}{EvaluateForceMoment}}(1.0);}
\DoxyCodeLine{\ \ \ \ \ \ cnt-\/>\mbox{\hyperlink{classnetdem_1_1_contact_p_p_a639a2c151ec84122932bc8674c696d94}{ApplyToParticle}}();}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{keywordtype}{double}\ pos\_x\ =\ obj\_p2.pos[0];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ Vec3d\ cnt\_force\{0,\ 0,\ 0\},\ cnt\_moment\{0,\ 0,\ 0\};}
\DoxyCodeLine{\ \ \ \ \ \ Vec3d\ dir\_n\{0,\ 0,\ 0\},\ dir\_s\{0,\ 0,\ 0\};}
