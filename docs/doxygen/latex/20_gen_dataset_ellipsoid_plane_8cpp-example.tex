...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ Vec3d\ dir\_n\ =\ u\_vert\ *\ vert\_0\ +\ v\_vert\ *\ vert\_1\ +\ w\_vert\ *\ vert\_2;}
\DoxyCodeLine{\ \ \ \ Math::Normalize(\&dir\_n);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ random\ distance}}
\DoxyCodeLine{\ \ \ \ Vec3d\ sup\_pos,\ sup\_dir\{-\/dir\_n[0],\ -\/dir\_n[1],\ -\/dir\_n[2]\};}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{double}\ dist\_max\ =\ cnt\_prob\ >\ 0.6\ ?\ dist\_sup\ :\ ellipsoid.bound\_sphere\_radius;}
