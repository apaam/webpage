...
\DoxyCodeLine{}
\DoxyCodeLine{VecXT<VecXT<double>>\ LoadDatasetTrimeshPlane(\textcolor{keywordtype}{string}\ filename)\ \{}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{return}\ VecXT<VecXT<double>>();}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ VecXT<VecXT<double>>\ dataset;}
\DoxyCodeLine{\ \ \textcolor{keywordtype}{string}\ str\_line,\ str\_num;}
\DoxyCodeLine{\ \ VecXT<double>\ data\_line;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_inputs\ =\ \textcolor{keyword}{new}\ Vec4d[num\_samples];}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_inputs\ =\ \textcolor{keyword}{new}\ Vec4d[num\_samples];}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_cnt\_flags\ =\ \textcolor{keyword}{new}\ \textcolor{keywordtype}{bool}[num\_samples];}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_cnt\_feats\ =\ \textcolor{keyword}{new}\ VecNT<double,\ 5>[num\_samples];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0,\ skip\ =\ 1;\ i\ <\ num\_samples;\ i\ +=\ skip)\ \{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\_inputs\ =\ 0;\ i\_inputs\ <\ 4;\ i\_inputs++)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][i\_inputs]\ =\ dataset[i][i\_inputs];}
...
\DoxyCodeLine{\ \ \ \ Vec4d\ quat\ =\ Math::Quaternion::FromRodrigues(rot\_angle,\ rot\_axis);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ obj\_w.SetPosition(-\/dist\_pc\_to\_plane\ *\ dir\_n[0],}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ -\/dist\_pc\_to\_plane\ *\ dir\_n[1],}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ -\/dist\_pc\_to\_plane\ *\ dir\_n[2]);}
