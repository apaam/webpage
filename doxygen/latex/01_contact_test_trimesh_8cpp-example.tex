...
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ VecXT<Vec3d>\ vab;}
\DoxyCodeLine{\ \ VecXT<Vec3i>\ fab;}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ stl\_tmp\ =\ sh.\mbox{\hyperlink{classnetdem_1_1_spherical_harmonics_a636e21871ecf0cd3f59153c285ecbd9e}{GetSTLModel}}(sh.node\_num\ *\ 2\ -\/\ 4);}
...
\DoxyCodeLine{\ \ obj\_p1.SetRodrigues(0.3,\ 0,\ 1,\ 0);}
...
\DoxyCodeLine{\ \ \ \ vert\ =\ Math::Rotate(vert,\ obj\_p1.quaternion);}
\DoxyCodeLine{\ \ \}}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&vert\ :\ nodes)\ \{}
\DoxyCodeLine{\ \ \ \ vert\ =\ Math::Rotate(vert,\ obj\_p2.quaternion);}
\DoxyCodeLine{\ \ \}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ obj\_p2.SetPosition(0,\ 0,\ pos\_z0\ -\/\ i\ *\ 0.001);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{keywordtype}{double}\ vol\ =\ GetContactVolume(stl\_model\_1,\ stl\_model\_2,\ obj\_p2.pos[2]);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ <<\ obj\_p2.moment[1]\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ obj\_p2.moment[2]\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ vol}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ <<\ endl;}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ obj\_p2.moment[0],\ obj\_p2.moment[1],\ obj\_p2.moment[2],}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ vol\});}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{\ \ \ \ obj\_p2.ClearMoment();}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ obj\_p2.SetPosition(0,\ 0,\ pos\_z0\ -\/\ 60\ *\ 0.001\ +\ i\ *\ 0.001);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ cnt\_solver.\mbox{\hyperlink{classnetdem_1_1_solver_s_d_f_p_p_af276bd15b726fdf4b4a66de8c17d2697}{Init}}(\&obj\_p2,\ \&obj\_p1);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{if}\ (cnt\_solver.\mbox{\hyperlink{classnetdem_1_1_solver_s_d_f_p_p_a8a63a1bf1e54ed1270a7dd8cad0c493e}{Detect}}())\ \{}
