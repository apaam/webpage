\hypertarget{90_random_packing_8cpp-example}{}\doxysection{90\+\_\+random\+\_\+packing.\+cpp}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}shape\_coded\_netsdf.hpp"{}}}
...
\DoxyCodeLine{\ \ \mbox{\hyperlink{classnetdem_1_1_linear_spring}{LinearSpring}}\ cnt\_model\ =\ \mbox{\hyperlink{classnetdem_1_1_linear_spring}{LinearSpring}}(2.0e4,\ 1.0e4,\ 0.7,\ 0.5);}
...
\DoxyCodeLine{\ \ netsdf.\mbox{\hyperlink{classnetdem_1_1_coded_net_s_d_f_a7c578dceb4f9c595c0bfca856ef77279}{InitFromModelFiles}}(\textcolor{stringliteral}{"{}ann\_SDF.xml"{}},\ \textcolor{stringliteral}{"{}latent\_code.txt"{}});}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ //\ shape\ template\ and\ particles}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ TriMesh\ netsdf;}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ netsdf.InitFromSTL("{}data/particle\_template.stl"{});}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ netsdf.Decimate(400);}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ netsdf.AlignAxes();}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ netsdf.SetSize(0.1);}}
\DoxyCodeLine{\ \ \textcolor{comment}{//\ sim-\/>scene.InsertShape(\&netsdf);}}
\DoxyCodeLine{}
