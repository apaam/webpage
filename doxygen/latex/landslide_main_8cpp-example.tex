...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}cgal\_wrapper.hpp"{}}}
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}cork\_wrapper.hpp"{}}}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}utils\_io.hpp"{}}}
...
\DoxyCodeLine{VecXT<Vec3d>\ DiscretizeSlideRegion(\textcolor{keywordtype}{string}\ \textcolor{keyword}{const}\ \&dem\_file\_pre,}
...
\DoxyCodeLine{\ \ \textcolor{keywordtype}{double}\ width\ =\ (num\_rows\ -\/\ 1)\ *\ spacing;}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ VecXT<Vec3d>\ pos\_list;}
...
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(0,\ 0,\ \textcolor{stringliteral}{"{}cnt\_model\_pp"{}});}
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(1,\ 0,\ \textcolor{stringliteral}{"{}cnt\_model\_pw"{}});}
\DoxyCodeLine{\ \ sim-\/>\mbox{\hyperlink{classnetdem_1_1_simulation_add17bfcd927bd2b7f14f05855c20bea3}{scene}}.SetCollisionModel(1,\ 1,\ \textcolor{stringliteral}{"{}cnt\_model\_pw"{}});}
\DoxyCodeLine{}
