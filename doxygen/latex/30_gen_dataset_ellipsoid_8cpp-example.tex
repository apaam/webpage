...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{double}\ len\_min\ =\ cnt\_prob\ >\ 0.6\ ?\ 0\ :\ -\/ellipsoid.bound\_sphere\_radius;}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ Vec4d\ quat\_conj\ =\ Math::Quaternion::Conjugate(quat);}
\DoxyCodeLine{\ \ \ \ Vec3d\ sup\_dir\_p2\_ref\ =\ Math::Rotate(dir\_n,\ quat\_conj);}
...
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{keywordflow}{if}\ (Math::NormL2(pos)\ >\ ellipsoid.bound\_sphere\_radius\ *\ 2)}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{comment}{//\ use\ distance\ from\ particle\ centroid\ to\ plane\ and\ plane\ normal\ as\ inputs}}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][0]\ =\ obj\_p2.pos[0];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][1]\ =\ obj\_p2.pos[1];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][2]\ =\ obj\_p2.pos[2];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][3]\ =\ obj\_p2.quaternion[0];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][4]\ =\ obj\_p2.quaternion[1];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][5]\ =\ obj\_p2.quaternion[2];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][6]\ =\ obj\_p2.quaternion[3];}
\DoxyCodeLine{}
