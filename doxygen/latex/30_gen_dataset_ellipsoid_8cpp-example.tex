\hypertarget{30_gen_dataset_ellipsoid_8cpp-example}{}\doxysection{30\+\_\+gen\+\_\+dataset\+\_\+ellipsoid.\+cpp}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{double}\ len\_min\ =\ cnt\_prob\ >\ 0.6\ ?\ 0\ :\ -\/ellipsoid.\mbox{\hyperlink{classnetdem_1_1_shape_aa2544899cc79d4ae84fc700f490a37dc}{bound\_sphere\_radius}};}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{double}\ len\_max\ =\ cnt\_prob\ >\ 0.6\ ?\ 0.1\ :\ 0;}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{double}\ len\_n\ =\ len\_min\ +\ uniform\_dist.Get()\ *\ (len\_max\ -\/\ len\_min);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespacenetdem_a13d5371f99b252a70fd5a5081b910370}{Vec4d}}\ quat\_conj\ =\ Math::Quaternion::Conjugate(quat);}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespacenetdem_aa1676e16ca66301040ee8d50376c72b9}{Vec3d}}\ sup\_dir\_p2\_ref\ =\ Math::Rotate(dir\_n,\ quat\_conj);}
...
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{keywordflow}{if}\ (Math::NormL2(pos)\ >\ ellipsoid.\mbox{\hyperlink{classnetdem_1_1_shape_aa2544899cc79d4ae84fc700f490a37dc}{bound\_sphere\_radius}}\ *\ 2)}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \ \ \textcolor{comment}{//\ volume\ and\ directional\ cross-\/section\ area\ of\ intersection\ as\ outputs}}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][0]\ =\ len\_n;}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][1]\ =\ dir\_n[0];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][2]\ =\ dir\_n[1];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][3]\ =\ dir\_n[2];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][4]\ =\ sup\_pos\_p1[0]\ +\ 0.5\ *\ len\_n\ *\ dir\_n[0];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][5]\ =\ sup\_pos\_p1[1]\ +\ 0.5\ *\ len\_n\ *\ dir\_n[1];}
\DoxyCodeLine{\ \ \ \ \ \ ds\_cnt\_feats[i][6]\ =\ sup\_pos\_p1[2]\ +\ 0.5\ *\ len\_n\ *\ dir\_n[2];}
\DoxyCodeLine{}
