\hypertarget{05_ave_num_linked_patches_8cpp-example}{}\doxysection{05\+\_\+ave\+\_\+num\+\_\+linked\+\_\+patches.\+cpp}
...
\DoxyCodeLine{\ \ \ \ polybezier.num\_cells\ =\ i;}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ cell\ :\ polybezier.linked\_patches\_list)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ ave\_num\ +=\ cell.size();}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \ \ cout\ <<\ i\ <<\ \textcolor{stringliteral}{"{},\ "{}}\ <<\ ave\_num\ /\ polybezier.linked\_patches\_list.size()}
