\hypertarget{00_sdf_demo_8cpp-example}{}\doxysection{00\+\_\+sdf\+\_\+demo.\+cpp}
...
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ "{}tetmesh.hpp"{}}}
...
\DoxyCodeLine{\ \ VecXT<double>\ dist\_list;}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keyword}{auto}\ \&node\ :\ tetmesh.\mbox{\hyperlink{classnetdem_1_1_tet_mesh_a851cb634900ec65f4370559106970bfb}{nodes}})\ \{}
\DoxyCodeLine{\ \ \ \ \ \ Vec3d\ pos\{pos\_x\_list[i],\ pos\_y\_list[i],\ pos\_z\_list[i]\};}
...
\DoxyCodeLine{\ \ printf(\textcolor{stringliteral}{"{}cost:\ \%f\ microsecond\ \(\backslash\)n"{}},\ dem\_profiler.\mbox{\hyperlink{classnetdem_1_1_d_e_m_profiler_a1807f89997ec1340772b0dc4cd99db6c}{timer\_list}}[TimerType::custom]\ /}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ 1.0\ /\ num\_trials\ /}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ tetmesh.\mbox{\hyperlink{classnetdem_1_1_tet_mesh_a851cb634900ec65f4370559106970bfb}{nodes}}.size());}
\DoxyCodeLine{}
