...
\DoxyCodeLine{\ \ \textcolor{keywordtype}{double}\ \mbox{\hyperlink{namespacenetdem_a96843b33c5f3ded90fa1bb19118df27d}{len\_n}}\ =\ len\_min\ +\ uniform\_dist.\mbox{\hyperlink{classnetdem_1_1_uniform_distribution_a7e39cbd0ed813d381022ad61986092bf}{Get}}()\ *\ (len\_max\ -\/\ len\_min);}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ sup\_dir\_p2\_ref\ =\ Math::Rotate(\mbox{\hyperlink{namespacenetdem_acfdf2ec334780123689f95ba696a20f1}{dir\_n}},\ Math::Quaternion::Conjugate(quat));}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespacenetdem_aa088f3b9daf31efbeb49c18db267c791}{Vec4d}}\ dquat\ =\ Math::Quaternion::FromRodrigues(rot\_angle,\ rot\_axis);}
