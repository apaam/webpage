\hypertarget{03_train_netspf_8cpp-example}{}\doxysection{03\+\_\+train\+\_\+netspf.\+cpp}
...
\DoxyCodeLine{\ \ \ \ \ \ mlpack::data::Load(\textcolor{stringliteral}{"{}archived/dataset\_SPF.txt"{}},\ dataset,\ \textcolor{keyword}{true});}
...
\DoxyCodeLine{\ \ model.\mbox{\hyperlink{classnetdem_1_1_regression_net_a758c000426a7fb15c7b97d24a6738fa9}{step\_size}}\ =\ 0.0001;}
...
\DoxyCodeLine{\ \ \ \ model.\mbox{\hyperlink{classnetdem_1_1_regression_net_a2e770b0c27b3dff14401815e762b2713}{Save}}(\textcolor{stringliteral}{"{}training/ann\_SPF\_"{}}\ +\ to\_string(i)\ +\ \textcolor{stringliteral}{"{}.xml"{}},\ \textcolor{stringliteral}{"{}SPF"{}});}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{if}\ (test\_accuracy\ <\ test\_accuracy\_best)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ test\_accuracy\_best\ =\ test\_accuracy;}
\DoxyCodeLine{\ \ \ \ \ \ model.\mbox{\hyperlink{classnetdem_1_1_regression_net_a2e770b0c27b3dff14401815e762b2713}{Save}}(\textcolor{stringliteral}{"{}ann\_SPF.xml"{}},\ \textcolor{stringliteral}{"{}SPF"{}});}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\}}
