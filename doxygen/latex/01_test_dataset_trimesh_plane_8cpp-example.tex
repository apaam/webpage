\hypertarget{01_test_dataset_trimesh_plane_8cpp-example}{}\doxysection{01\+\_\+test\+\_\+dataset\+\_\+trimesh\+\_\+plane.\+cpp}
...
\DoxyCodeLine{}
\DoxyCodeLine{\mbox{\hyperlink{namespacenetdem_a088168eeea9e6ce8d0500cdfd7ef9c87}{VecXT<VecXT<double>}}>\ LoadDatasetTrimeshPlane(\textcolor{keywordtype}{string}\ filename)\ \{}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_inputs\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{namespacenetdem_a13d5371f99b252a70fd5a5081b910370}{Vec4d}}[num\_samples];}
...
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_inputs\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{namespacenetdem_a13d5371f99b252a70fd5a5081b910370}{Vec4d}}[num\_samples];}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_cnt\_flags\ =\ \textcolor{keyword}{new}\ \textcolor{keywordtype}{bool}[num\_samples];}
\DoxyCodeLine{\ \ \textcolor{keyword}{auto}\ *ds\_cnt\_feats\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{namespacenetdem_a4c6a34e4b9bc01901ac527bb8ea83909}{VecNT<double,\ 5>}}[num\_samples];}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0,\ skip\ =\ 1;\ i\ <\ num\_samples;\ i\ +=\ skip)\ \{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\_inputs\ =\ 0;\ i\_inputs\ <\ 4;\ i\_inputs++)\ \{}
\DoxyCodeLine{\ \ \ \ \ \ ds\_inputs[i][i\_inputs]\ =\ dataset[i][i\_inputs];}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{namespacenetdem_a13d5371f99b252a70fd5a5081b910370}{Vec4d}}\ quat\ =\ Math::Quaternion::FromRodrigues(rot\_angle,\ rot\_axis);}
\DoxyCodeLine{}
\DoxyCodeLine{\ \ \ \ obj\_w.\mbox{\hyperlink{classnetdem_1_1_wall_a72260b6cfb980c6a53aaf716cff0e57e}{SetPosition}}(-\/dist\_pc\_to\_plane\ *\ dir\_n[0],}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ -\/dist\_pc\_to\_plane\ *\ dir\_n[1],}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ -\/dist\_pc\_to\_plane\ *\ dir\_n[2]);}
